...
export const teamPageTitleClassName =
...
export const teamDialogContentClassName = (isDesktop: boolean) =>
	cn(
		'rounded-[var(--radius-surface)] border-border bg-card p-0 shadow-[0_30px_80px_-34px_rgba(0,0,0,0.55)]',
		{ 'sm:max-w-[396px]': isDesktop },
	)

export const teamDialogTitleClassName = 'text-[18px] font-semibold tracking-tight'

export const teamDialogLabelClassName = 'text-[13px] font-medium mb-1.5'
...
export const teamDialogFooterClassName = (isDesktop: boolean) =>
